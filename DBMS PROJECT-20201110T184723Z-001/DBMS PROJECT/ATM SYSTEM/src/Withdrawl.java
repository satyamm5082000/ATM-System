...
public class Withdrawl extends JFrame implements ActionListener{
    ...
    Withdrawl(){
        ...
        b1.setBounds(220,430,160,50);
        add(b1);
        
        b2.setBounds(400,430,160,50);
        add(b2);
        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    ResultSet rs = c1.s.executeQuery("SELECT * from bank where time = ( SELECT  max(time) as time FROM bank where pin="+b+" group by pin)");
                    ...
                    if(rs.next()){
                        ...
                        if (balance > d)
                        {
                        	...
                        	String q1= "insert into bank values('"+pin+"',null,'"+d+"','"+balance+"','"+date+"','"+time+"')";

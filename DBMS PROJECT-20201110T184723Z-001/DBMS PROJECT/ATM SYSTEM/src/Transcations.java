...
public class Transcations extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){ 
        	...
        	//String pinn = String.valueOf(pass.getPassword());
            ...
            try {
                ...
                ResultSet rs = c1.s.executeQuery("SELECT  * from bank where time = ( SELECT  max(time) as time FROM bank where pin="+pinn+" group by pin)");
                ...
                JOptionPane.showMessageDialog(null,"Your Account Balance is "+balance);
                	...
                	JOptionPane.showMessageDialog(null,"Your Pin is wrong or no transcation is perform through this pin");
